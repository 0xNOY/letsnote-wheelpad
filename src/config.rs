...
pub struct Scroll {
    ...
    pub detect_area_aspect_ratio: f64,
...
impl Config {
    ...
    pub fn validate(&self) -> Result<()> {
        ...
        if !s.detect_area_aspect_ratio.is_finite() || s.detect_area_aspect_ratio <= 0.0 {
            return Err(Error::ConfigFloatRange {
                key: "scroll.detect_area_aspect_ratio",
                value: s.detect_area_aspect_ratio,
                expected: "a finite value greater than 0",
            });
        }
...
mod tests {
    ...
    fn defaults_match_windows() {
        ...
        assert_eq!(c.scroll.detect_area_aspect_ratio, 1.0);
    ...
    fn validate_rejects_invalid_radial_gate_geometry() {
        ...
        c.scroll.detect_area_aspect_ratio = f64::NAN;
        assert!(c.validate().is_err());
    }
}
